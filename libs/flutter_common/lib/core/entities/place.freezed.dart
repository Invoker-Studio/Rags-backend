...
abstract class $PlaceEntityCopyWith<$Res> {
  ...
  @useResult
  $Res call({LatLngEntity coordinates, String address});
...
class _$PlaceEntityImpl implements _PlaceEntity {
  const _$PlaceEntityImpl({required this.coordinates, required this.address});
  ...
  @override
  String toString() {
    return 'PlaceEntity(coordinates: $coordinates, address: $address)';
  }
...
abstract class _PlaceEntity implements PlaceEntity {
  const factory _PlaceEntity(
      ...
      required final String address}) = _$PlaceEntityImpl;
