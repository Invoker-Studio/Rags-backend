...
import 'package:rider_flutter/core/repositories/profile_repository.prod.dart'
    as _i46;
import 'package:rider_flutter/core/repositories/wallet_repository.dart' as _i67;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.lazySingleton<_i38.PaymentMethodsRepository>(
      () => _i39.PaymentMethodsRepositoryImpl(gh<_i17.GraphqlDatasource>()),
      registerFor: {_prod},
    );
    gh.lazySingleton<_i38.PaymentMethodsRepository>(
      () => _i40.PaymentMethodsRepositoryMock(),
      registerFor: {_dev},
    );
    ...
    gh.lazySingleton<_i43.ProfileRepository>(
      () => _i46.ProfileRepositoryProd(gh<_i17.GraphqlDatasource>()),
      registerFor: {_prod},
    );
    ...
    gh.lazySingleton<_i67.WalletRepository>(
      () => _i68.WalletRepositoryImpl(gh<_i17.GraphqlDatasource>()),
      registerFor: {_prod},
    );
    gh.lazySingleton<_i67.WalletRepository>(
      () => _i69.WalletRepositoryMock(),
      registerFor: {_dev},
    );
